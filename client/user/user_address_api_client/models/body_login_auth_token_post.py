...
T = TypeVar("T", bound="BodyLoginAuthTokenPost")


@_attrs_define
class BodyLoginAuthTokenPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_login_auth_token_post = cls(
            username=username,
            password=password,
        ...
        body_login_auth_token_post.additional_properties = d
        return body_login_auth_token_post
